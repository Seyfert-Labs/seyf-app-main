...
export const SEYF_WALLET_BALANCE_POLL_MS = 8_000
/** @deprecated usar SEYF_WALLET_BALANCE_POLL_MS */
export const ACCESLY_BALANCE_POLL_MS = SEYF_WALLET_BALANCE_POLL_MS
...
export const SEYF_WALLET_BALANCE_EXTRA_DELAYS_MS = [2_000, 6_000] as const
/** @deprecated usar SEYF_WALLET_BALANCE_EXTRA_DELAYS_MS */
export const ACCESLY_BALANCE_EXTRA_DELAYS_MS = SEYF_WALLET_BALANCE_EXTRA_DELAYS_MS
